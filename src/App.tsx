...
const PARTICIPANT_TEMPLATE_TSV = [
  '部門\t姓名\tID\t是否參加抽獎',
  '生產部\t王小明\tA001\t是',
  '業務部\t陳小美\tA002\t是',
  '管理部\t林大明\tA003\t否',
].join('\n');
const PRIZE_TEMPLATE_TSV = [
